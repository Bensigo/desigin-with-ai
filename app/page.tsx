    ...
    <>
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden">
          <div className="hatch absolute inset-0 opacity-[0.5]" aria-hidden />
        ...
        <section style={{ borderTop: "1px solid var(--line)", borderBottom: "1px solid var(--line)" }}>
          <div className="spade-wrap py-7 flex flex-wrap items-center gap-x-10 gap-y-3 justify-between">
            <MonoLabel>► TRUSTED BY 4,200+ OPERATING TEAMS</MonoLabel>
            <div className="flex flex-wrap items-center gap-x-8 gap-y-2 font-display text-[18px]" style={{ color: "var(--green-700)", fontWeight: 700 }}>
              <span>Northwind</span>
              <span>Atlas Freight</span>
              <span>Meridian</span>
              <span>Glasshaus</span>
              <span>Vector Labs</span>
            </div>
          </div>
        </section>
        ...
        <section id="product" className="spade-wrap py-24">
          ...
          <div className="mt-14 grid md:grid-cols-2 gap-px" style={{ background: "var(--line)" }}>
            {FEATURES.map((f) => (
              <div key={f.title} className="p-8 md:p-10" style={{ background: "var(--surface-page)" }}>
        ...
        <section id="treasury" style={{ background: "var(--green-950)", color: "var(--paper)" }}>
          <div className="spade-wrap py-24">
            <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-14">
              <div>
                <Eyebrow index="// 03">TREASURY, INSTRUMENTED</Eyebrow>
              ...
              <div className="grid sm:grid-cols-2 gap-x-10 gap-y-12 self-center">
                <Stat inverse value="4.32%" label="► TREASURY APY" sub="Accrued and posted daily" />
                <Stat inverse value="T+0" label="► DOMESTIC PAYMENTS" sub="Instant rails where available" />
                <Stat inverse value="$0" label="► MONTHLY ACCOUNT FEE" sub="No minimums, no tiers" />
                <Stat inverse value="99.99%" label="► LEDGER UPTIME" sub="Trailing 12 months" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="developers" className="spade-wrap py-24">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <div>
              <Eyebrow index="// 04">PAYMENTS API</Eyebrow>
